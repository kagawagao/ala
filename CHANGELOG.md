...
* Add context-aware FilterDrawer with keyboard shortcut (Ctrl+Shift+F) ([#70](https://github.com/kagawagao/ala/issues/70)) ([c59215c](https://github.com/kagawagao/ala/commit/c59215c6606eefa88eb052d6d5031887e7e3393a))
* add HCI filter and viewer components ([#93](https://github.com/kagawagao/ala/issues/93)) ([de41b39](https://github.com/kagawagao/ala/commit/de41b39b5fb7581b3ee417d8e6b83b544a0580dd))
* hide filter sidebar by default ([c3bc2d5](https://github.com/kagawagao/ala/commit/c3bc2d5c4f4fce3fcab014211e9613e7f5ebf498))
* lazy log streaming — filter-on-demand backend ([#90](https://github.com/kagawagao/ala/issues/90)) ([630ef70](https://github.com/kagawagao/ala/commit/630ef70de838667f56be2847b05f8466fabea7d4))
* local file streaming, conditional Tabs, and upload popover UX ([#89](https://github.com/kagawagao/ala/issues/89)) ([13a3d63](https://github.com/kagawagao/ala/commit/13a3d6312eb918508b6182850c94ea60d33f6b7e))
* PCAP network capture analysis with lazy-loading architecture ([#92](https://github.com/kagawagao/ala/issues/92)) ([5bc5871](https://github.com/kagawagao/ala/commit/5bc58715143aaccbaf79adc7954b5cc5bc6c2a97))
* update FilterDrawer layout and improve type imports ([114d384](https://github.com/kagawagao/ala/commit/114d384a873bf5d2fdc12ac68d75ee9d3eef6d84))

### Bug Fixes

* replace eager log loading with agentic lazy approach ([#91](https://github.com/kagawagao/ala/issues/91)) ([15739eb](https://github.com/kagawagao/ala/commit/15739eb942181b135e47807d6052752539f3a1db))
